...
tracer = Tracer(
    service_name=os.getenv("ELASTIC_APM_SERVICE_NAME", "llm-detections-proxy"),
    config={
        "SERVICE_NAME": "llm-detections-proxy",
...
def azure_openai_proxy():
    ...
    with tracer.start_as_current_span("proxy-llm-detections"):
